...
for (var i = 12; i <= 19; i++ ){
  (function(i, actual) {
    it('it has a preifx of 5018 and a length of ' + i, function() {
  ...
  actual = actual + '0';
    ...
    var actual = '502012345678';
    for (var i = 12; i <= 19; i++ ){
      (function(i, actual) {
        it('it has a preifx of 5020 and a length of ' + i, function() {
          expect(detectNetwork(actual)).to.equal('Maestro');
        });
      })(i,actual)
      actual = actual + '0';
     ...
     var actual = '503812345678';
    for (var i = 12; i <= 19; i++ ){
      (function(i, actual) {
        it('it has a preifx of 5038 and a length of ' + i, function() {
          expect(detectNetwork(actual)).to.equal('Maestro');
        });
      })(i,actual)
      actual = actual + '0';
      ...
      var actual = '630412345678';
      for (var i = 12; i <= 19; i++ ){
          (function(i, actual) {
            it('it has a preifx of 6304 and a length of ' + i, function() {
              expect(detectNetwork(actual)).to.equal('Maestro');
            });
          })(i,actual)
          actual = actual + '0';
  ...
  for (var prefix = 622126; prefix <= 622925; prefix++) {
    ...
    for (var length = 16; length <= 19; length++){
      (function(length, actual, prefix) {
        it ('has a prefox of ' + prefix +' and a length of ' +length, function() {
